...
import { loadOrCreate, save, getDefaults, validate, validateRepoUniqueness, validateGlobPatterns, hasPathTraversal, VALID_CONFLICT_STRATEGIES, VALID_SYNC_DIRECTIONS, VALID_REPO_TYPES, VALID_ROLES, } from '../../packages/cli/src/git/config-manager';
