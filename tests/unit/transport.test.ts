...
// TODO: Module not yet implemented — skipping until transport layer is built
import { describe } from 'vitest';
describe.skip('transport (not yet implemented)', () => {});
/*

import { TransportRegistry } from '../../packages/core/src/transport/transport-registry';
import { PlatformAdapter } from '../../packages/core/src/transport/platform-adapter';
import { AdapterFactory } from '../../packages/core/src/transport/adapter-factory';
import { resolveGraphSource, matchGlob, extractName, deepMerge } from '../../packages/core/src/transport/utils';
import { getTransform, listTransforms } from '../../packages/core/src/transport/transforms';
import { PlatformMappingConfigSchema } from '../../packages/core/src/transport/schemas';
