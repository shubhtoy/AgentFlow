...
describe.skip('hook-abstraction-layer (not yet implemented)', () => {});
/*
import { describe, it, expect } from 'vitest';
import { HookAbstractionLayer, HOOK_EVENT_MAP, HOOK_ACTION_MAP } from '../../packages/core/src/transport/hook-abstraction-layer.js';
