...
<Tabs items={['Automatic (0–2)', 'On-demand (3–4)']}>
  ...
  <Tab value="On-demand (3–4)">
    ...
    **Layer 3 — Reference Material** includes instructions, capabilities, and runbooks. These files are stable across runs — they represent your conventions, tool definitions, and decision criteria. Loaded via `{{category/name}}`.
...
- 4 runbook files (~300 tokens each = 1,200 tokens)
...
| All runbooks | 1,200 | 0 | No runbook referenced |
