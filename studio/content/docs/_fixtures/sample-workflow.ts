...
export const buildFeatureWorkflow = {
  ...
  edges: [
    ...
    { from: 'review-requirements-gate', to: 'create-design', condition: 'instructions/requirements-approved' },
    { from: 'review-requirements-gate', to: 'gather-requirements', condition: 'instructions/requirements-rejected' },
    { from: 'create-design', to: 'review-design-gate', condition: null },
    { from: 'review-design-gate', to: 'plan-tasks', condition: 'instructions/design-approved' },
    { from: 'review-design-gate', to: 'create-design', condition: 'instructions/design-rejected' },
    { from: 'plan-tasks', to: 'review-tasks-gate', condition: null },
    { from: 'review-tasks-gate', to: 'implement-task', condition: 'instructions/tasks-approved' },
    { from: 'review-tasks-gate', to: 'plan-tasks', condition: 'instructions/tasks-rejected' },
    { from: 'implement-task', to: 'task-completion-gate', condition: null },
    { from: 'task-completion-gate', to: 'implement-task', condition: 'instructions/more-tasks-remain' },
    { from: 'task-completion-gate', to: 'implement-task', condition: 'instructions/task-failed' },
    { from: 'task-completion-gate', to: 'verify-feature', condition: 'instructions/all-tasks-done' },
...
export const sampleResources = {
  ...
  conditions: ['requirements-approved', 'requirements-rejected', 'design-approved', 'design-rejected', 'tasks-approved', 'tasks-rejected', 'more-tasks-remain', 'task-failed', 'all-tasks-done', 'checkpoint'],
