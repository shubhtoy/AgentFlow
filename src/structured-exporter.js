...
const { resolveToPath } = require('./exporter');
const { collectWorkflowFiles, toFileMap } = require('./transport/collect-files');
...
function exportParsed(graph, workflowId) {
  ...
  const { resolveTemplateVars } = require('./transport/default-export');
