...
export type FormType = 'text' | 'textarea' | 'select' | 'boolean' | 'taglist' | 'group' | 'workflow-picker' | 'object-list'
...
export const FRONTMATTER_SCHEMAS: FrontmatterSchemas = {
  ...
  node: {
    name:        { type: 'string', required: true, label: 'Name', formType: 'text', section: 'Identity' },
    type:        { type: 'string', required: true, enum: ['step', 'sub-workflow'], label: 'Type', formType: 'select', section: 'Identity' },
    description: { type: 'string', label: 'Description', formType: 'textarea', section: 'Identity' },
  ...
  instruction: {
    ...
    platforms:   { type: 'object', label: 'Platform Hints', formType: 'textarea', section: 'Configuration', hint: 'Opaque platform-specific hints (read by exporters)' },
    narrativeTemplate: { type: 'object', label: 'Narrative Template', formType: 'group', section: 'Narrative', children: {
      prefix: { type: 'string', label: 'Prefix', formType: 'text' },
      suffix: { type: 'string', label: 'Suffix', formType: 'text' },
    }},
  ...
  skill: {
    ...
    'allowed-tools': { type: 'string', label: 'Allowed Tools', formType: 'text', section: 'Configuration', hint: 'Agent Skills spec field' },
    tags:            { type: 'string[]', label: 'Tags', formType: 'taglist', section: 'Identity' },
  },
  ...
  condition: {
    name:        { type: 'string', required: true, label: 'Name', formType: 'text', section: 'Identity' },
    description: { type: 'string', label: 'Description', formType: 'textarea', section: 'Identity' },
    check:       { type: 'string', label: 'Check Expression', formType: 'text', section: 'Configuration', hint: 'The condition to evaluate' },
  },
